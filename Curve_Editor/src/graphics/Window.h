...
public:
	...
	void cursorThreeD () { glfwSetInputMode(window.get(), GLFW_CURSOR, GLFW_CURSOR_DISABLED); }

	void cursorTwoD() { glfwSetInputMode(window.get(), GLFW_CURSOR, GLFW_CURSOR_NORMAL); }
